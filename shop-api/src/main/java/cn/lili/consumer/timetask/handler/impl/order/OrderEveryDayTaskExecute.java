    ...
    private void memberEvaluation(OrderSetting orderSetting) {
        ...
        if (!orderItems.isEmpty()) {
            for (OrderItem orderItem : orderItems) {
                ...
                userEvaluationDTO.setOrderItemSn(orderItem.getSn());
                userEvaluationDTO.setContent("系统默认好评");
                userEvaluationDTO.setGoodsId(orderItem.getGoodsId());
                userEvaluationDTO.setSkuId(orderItem.getSkuId());
                userEvaluationDTO.setGrade(EvaluationGradeEnum.GOOD.name());
                userEvaluationDTO.setDeliveryScore(5);
                userEvaluationDTO.setDescriptionScore(5);
                userEvaluationDTO.setServiceScore(5);

                userEvaluationService.addMemberEvaluation(userEvaluationDTO, false);
            }
        }
    }
