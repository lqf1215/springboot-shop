...
public class MemberReceiptController {
    ...
    @Autowired
    private UserReceiptService memberReceiptService;

    @ApiOperation(value = "查询会员发票列表")
    @GetMapping
    public ResultMessage<Object> page(UserReceiptVO userReceiptVO, PageVO page) {
        return ResultUtil.data(memberReceiptService.getPage(userReceiptVO, page));
    }
    ...
    public ResultMessage<Object> add(UserReceiptAddVO userReceiptAddVO) {
        return ResultUtil.data(memberReceiptService.addMemberReceipt(userReceiptAddVO, UserContext.getCurrentUser().getId()));
    }
    ...
    public ResultMessage<Object> update(@PathVariable String id, UserReceiptAddVO userReceiptAddVO) {
        ...
        return ResultUtil.data(memberReceiptService.editMemberReceipt(userReceiptAddVO, id));
    }
