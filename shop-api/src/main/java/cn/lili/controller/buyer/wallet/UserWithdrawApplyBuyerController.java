...
public class UserWithdrawApplyBuyerController {
    @Autowired
    ...
    @GetMapping
    public ResultMessage<IPage<UserWithdrawApply>> getByPage(PageVO page, MemberWithdrawApplyQueryVO memberWithdrawApplyQueryVO) {
        memberWithdrawApplyQueryVO.setUserId(UserContext.getCurrentUser().getId());
        //构建查询 返回数据
        IPage<UserWithdrawApply> memberWithdrawApplyPage = userWithdrawApplyService.getMemberWithdrawPage(page, memberWithdrawApplyQueryVO);
