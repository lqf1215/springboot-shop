...
//        String storeId = Objects.requireNonNull(UserContext.getCurrentUser()).getStoreId();
        return ResultUtil.data(freightTemplateService.getAllFreightTemplateList());
    }
    ...
    public ResultMessage<FreightTemplateVO> edit(@PathVariable String id, @RequestBody @Valid FreightTemplateVO freightTemplateVO) {
        FreightTemplateVO judgment = OperationalJudgment.judgment(freightTemplateService.getFreightTemplate(id));
        System.out.println("judgment:"+judgment.toString());
