 ...
 */
public interface UserStatisticsMapper extends BaseMapper<MemberStatisticsData> {
     ...
     * @return 会员统计数量
     */
    @Select("SELECT  COUNT(0)  FROM li_user  ${ew.customSqlSegment}")
    ...
    List<UserDistributionVO> distribution();
}