...
import cn.lili.modules.user.entity.vo.UserDistributionVO;
...
import cn.lili.modules.statistics.mapper.UserStatisticsMapper;
 ...
 */
@Service
public class UserStatisticsServiceImpl extends ServiceImpl<UserStatisticsMapper, MemberStatisticsData> implements UserStatisticsService {
    ...
    @Override
    public List<UserDistributionVO> distribution() {
