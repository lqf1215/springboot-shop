...
//                ConnectQueryDTO.builder().userId(order.getUserId()).unionType(ConnectEnum.WECHAT.name()).build()
//        );
//        if (connect == null) {
//            return;
//        }

        log.info("微信消息发送消息：{}", order.getUserId() + "-" + sn);
        //获取token
...
//        Connect connect = connectService.queryConnect(
//                ConnectQueryDTO.builder().userId(order.getUserId()).unionType(ConnectEnum.WECHAT_MP_OPEN_ID.name()).build()
//        );
//        if (connect == null) {
//            return;
//        }

        log.info("微信消息订阅消息发送：{}", order.getUserId() + "-" + sn);
        //获取token
