...
import cn.lili.modules.user.entity.dos.StoreCollection;
import cn.lili.modules.user.entity.dto.CollectionDTO;
import cn.lili.modules.user.entity.vo.StoreCollectionVO;
import cn.lili.modules.user.mapper.StoreCollectionMapper;
import cn.lili.modules.user.service.StoreCollectionService;
...
public class StoreCollectionServiceImpl extends ServiceImpl<StoreCollectionMapper, StoreCollection> implements StoreCollectionService {
    ...
    public IPage<StoreCollectionVO> storeCollection(PageVO pageVo) {
        ...
        queryWrapper.eq("sc.user_id", UserContext.getCurrentUser().getId());
    ...
    public StoreCollection addStoreCollection(String storeId) {
        if (this.getOne(new LambdaUpdateWrapper<StoreCollection>()
                .eq(StoreCollection::getUserId, UserContext.getCurrentUser().getId())
