...
//    private StoreService storeService;
    ...
    public void updateGoodsCommentNum(String goodsId) {
        ...
        //修改商品好评率
        LambdaQueryWrapper<UserEvaluation> goodEvaluationQueryWrapper = new LambdaQueryWrapper<>();
        goodEvaluationQueryWrapper.eq(UserEvaluation::getId, goodsId);
        goodEvaluationQueryWrapper.eq(UserEvaluation::getGrade, EvaluationGradeEnum.GOOD.name());
        //好评数量
        long highPraiseNum = userEvaluationService.count(goodEvaluationQueryWrapper);
        //好评率
