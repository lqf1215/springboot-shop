 ...
 */
@Service
public class UserMessageServiceImpl extends ServiceImpl<MemberMessageMapper, MemberMessage> implements MemberMessageService {
    ...
    public IPage<MemberMessage> getPage(MemberMessageQueryVO memberMessageQueryVO, PageVO pageVO) {
        ...
        //会员id
        queryWrapper.eq(StringUtils.isNotEmpty(""+memberMessageQueryVO.getUserId()), "user_id", memberMessageQueryVO.getUserId());
        //消息状态
