...
public class StoreFlowServiceImpl extends ServiceImpl<StoreFlowMapper, StoreFlow> implements StoreFlowService {
    ...
    public void payOrder(String orderSn) {
        ...
        for (OrderItem item : orderItems) {
            ...
            storeFlow.setUserId(""+order.getUserId());
            storeFlow.setUserName(order.getUserName());
    ...
    public void refundOrder(AfterSale afterSale) {
        ...
        storeFlow.setUserId(afterSale.getUserId());
        storeFlow.setUserName(afterSale.getUserName());
