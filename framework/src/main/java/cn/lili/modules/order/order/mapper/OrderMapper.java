...
public interface OrderMapper extends BaseMapper<Order> {
     ...
     * @return 导出订单DTO列表
     */
    @Select("SELECT o.sn,o.create_time,o.user_name,o.consignee_name,o.consignee_mobile,o.consignee_address_path,o.consignee_detail," +
     ...
     * @return 简短订单分页
     */
    @Select("select o.sn,o.flow_price,o.create_time,o.order_status,o.pay_status,o.payment_method,o.payment_time,o.user_name,o.store_name as store_name,o.store_id as store_id,o.client_type,o.order_type,o.deliver_status " +
