 ...
 */
public interface UserWithdrawApplyService extends IService<UserWithdrawApply> {
     ...
     * @return 提现记录分页
     */
    IPage<UserWithdrawApply> getMemberWithdrawPage(PageVO pageVO, MemberWithdrawApplyQueryVO memberWithdrawApplyQueryVO);
