...
public class WalletLog extends BaseIdEntity {
     ...
     */
    public WalletLog(String userName, MemberWalletUpdateDTO memberWalletUpdateDTO) {
     ...
     */
    public WalletLog(String userName, MemberWalletUpdateDTO memberWalletUpdateDTO, boolean isReduce) {
        this.setUserId(memberWalletUpdateDTO.getUserId());
        this.setUserName(userName);
