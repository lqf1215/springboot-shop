...
ALTER TABLE li_user_coupon RENAME COLUMN is_platform TO platform_flag;
...
-- 增加会员表索引
ALTER TABLE li_user ADD INDEX query_mobile (`mobile`) COMMENT 'query_member';
-- 会员签到唯一索引 惠券查询索引
ALTER TABLE li_user_sign ADD INDEX query_create_time (`create_time`) COMMENT 'query_create_time';
ALTER TABLE li_user_sign ADD INDEX query_user_id (`user_id`) COMMENT 'query_user_id';
ALTER TABLE li_user_sign add unique uk_member_day (user_id, create_time) COMMENT 'uk_member_day';